(function($) {
	...
	function headerStyle() {
		if($('.main-header').length){
			...
			// Change: Stick after scrolling past header-top instead of full header height
			var topHeight = $('.header-top').height() || 0;
	...
	if($('.mobile-menu').length){
		...
		// Removed dead sticky-header reference to prevent potential console errors or unexpected behavior
